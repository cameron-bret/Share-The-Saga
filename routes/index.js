...
router.get('/edit/:authorId', authorController.update)
router.post('/edit/:authorId', authorController.edit)
...
router.get('/edit/:booksId', booksController.update)
router.post('/edit/:booksId', booksController.edit)
